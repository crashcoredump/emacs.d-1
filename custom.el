(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (frame-purpose company-lsp lsp-python lsp-ui lsp-mode go-mode keychain-environment plan9-theme toc-org ob-ipython origami restclient purescript-mode haskell-mode ein anaconda-mode evil projectile git-blamed flycheck company anzu ido-completing-read+ avy nameframe undo-tree company-jedi python-docstring highlight-indent-guides simple-mpc browse-at-remote dockerfile-mode evil-cleverparens yascroll yaml-mode web-mode virtualenvwrapper tao-theme swiper smooth-scrolling smooth-scroll smex smart-mode-line scss-mode scroll-restore reveal-in-finder rainbow-delimiters racket-mode pyenv-mode psci project-explorer paren-face paredit ox-reveal org-journal org-bullets nose nlinum mu4e-alert material-theme markdown-mode magit link-hint leuven-theme ledger-mode json-rpc json-mode js2-mode jedi indent-guide idomenu ido-vertical-mode ido-ubiquitous htmlize hl-sexp highlight-symbol highlight-parentheses gitignore-mode gitconfig-mode git-messenger git-gutter git-blame ghc geiser fullframe flycheck-ledger flycheck-haskell flx-ido fill-column-indicator exec-path-from-shell evil-vimish-fold evil-surround evil-search-highlight-persist evil-nerd-commenter evil-matchit evil-leader evil-anzu elm-mode elixir-mode eink-theme dired+ diminish cyphejor company-restclient company-emoji company-anaconda buffer-move bind-key beacon ag ac-anaconda)))
